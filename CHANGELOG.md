...
- **A section for Obsidian's own *Show all file types***, the other rule deciding what a dropdown can list: it says to look for that setting and turn it on to see every file, and the button beside it opens that page. Headed in Obsidian's words, in 45 languages.
