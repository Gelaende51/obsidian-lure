...
- **Names that begin with what you typed come first in the dropdown**, marked with a line down their edge — blue where they share more than you typed, green on the branch the offer takes where they part — ahead of the names that only contain it. Each of them underlines the step <kbd>Tab</kbd> would take toward it, not only the one that is offered.
