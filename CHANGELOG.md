...
- **Lure's settings link to Obsidian's own *Show all file types***, which is the other rule deciding what a dropdown can list. The link is worded by Obsidian and opens the page it names.
