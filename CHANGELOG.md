...
- **Lure's settings point at Obsidian's own *Show all file types***, which is the other rule deciding what a dropdown can list. The line and the button beside the toggle are worded by Obsidian, and the button goes to that page.
