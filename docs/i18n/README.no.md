<!-- Oversettelse av README.md — status: commit d116bbc.
...
- **Opphav** — en modell som skriver Obsidian-tillegg har lært det av åpen kildekode, dokumentasjon, forumsvar og feilrapporter som folk skrev og ga bort. Ingen av dem ble spurt, kreditert eller betalt. Det er det største ukrediterte bidraget her, og det fortjener støtten din mer enn dette tillegget: skal du velge hvor noe sendes, send det dit.
