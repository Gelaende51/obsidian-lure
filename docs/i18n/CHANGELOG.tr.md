...
- **Alınmış bir ad reddetmek yerine sorar.** Zaten var olan bir ada taşıma veya yeniden adlandırma yapmak, her iki dosyayı da tam yollarıyla gösteren bir iletişim kutusu açar. Yolda olanı yeniden adlandırıp devam edebilir, onunla yer değiştirebilirsiniz (klasörler arasında: her biri kendi adını korur ve diğerinin klasörünü alır) ya da onunla ad değiştirebilirsiniz (tek bir klasör içinde). İptal hiçbir şeyi taşımaz. Her düğme, üzerine geldiğinizde ne yapacağını söyler. Açılır listeden alınmış bir adı seçmek de aynısını sorar, aynı şekilde bir dosyayı zaten o adı taşıyan bir klasöre bırakmak da. İletişim kutusundaki yeniden adlandırma alanındaki ad, alınmışken kırmızıdır.
