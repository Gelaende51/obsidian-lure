...
- **Một tên đã được dùng sẽ hỏi thay vì từ chối.** Di chuyển hoặc đổi tên tới một tên đã có sẵn sẽ mở một hộp thoại với hai đường dẫn bạn có thể chỉnh sửa: tệp của bạn sẽ đi đâu, và tệp đang chắn đường sẽ đi đâu, có màu đỏ khi nó vẫn đang bị dùng. Mỗi đường dẫn cũng được vẽ theo cách thanh đường dẫn vẽ một đường dẫn, với các phần khác nhau được tô màu và rút ngắn sau cùng. Cả hai ô đều có danh sách; ô thứ hai chứa các cách thoát thường dùng — đổi chỗ (nó đi tới thư mục cũ của tệp bạn), đổi tên (nó ở lại và nhận tên cũ của tệp bạn), đổi cả hai (nó nhận đường dẫn cũ của tệp bạn), `-1`, `-bak` và `-old` kèm theo tên của chính nó, và hai tên mà các tệp từng có. Một cách thoát có đường dẫn đã bị dùng thì bị làm mờ xám. Chọn một cách chỉ điền vào ô; Áp dụng di chuyển cả hai, kèm mọi liên kết; Hủy thì không di chuyển gì cả. Chọn một tên đã bị dùng từ danh sách thả xuống cũng hỏi như vậy, và thả một tệp vào thư mục đã có sẵn tên đó cũng thế.
...
- **Gợi ý luôn là thứ mà Tab sẽ viết.** Ở chỗ các tên không còn trùng nhau nữa, trường nhập gợi ý bước tiến về phía cái đầu tiên trong số chúng, và hàng mà Tab sẽ hướng tới là cái quyết định điều đó; gõ đè lên một tên để nguyên phần mở rộng của nó và gợi ý xuất hiện trước phần đó; một thư mục vừa bước vào sẽ gợi ý bước đầu tiên của nó. Trước đây, có những trạng thái không gợi ý gì trong khi Tab vẫn cứ viết một cái gì đó. Gạch chân của danh sách thả xuống đi theo gợi ý khi nó thay đổi, và Tab trên một hàng bạn đã trỏ tới bằng phím mũi tên sẽ nhận hàng đó chứ không phải hàng bên cạnh.
...
- **Những tên bắt đầu bằng thứ bạn đã gõ đứng đầu danh sách thả xuống**, được đánh dấu bằng một đường kẻ dọc theo cạnh — màu xanh dương ở chỗ chúng chia sẻ nhiều hơn những gì bạn gõ, màu xanh lá trên nhánh mà gợi ý đi theo ở chỗ chúng tách ra — đứng trước những tên chỉ chứa nó ở đâu đó. Mỗi tên trong số đó gạch chân bước mà <kbd>Tab</kbd> sẽ tiến tới nó, không chỉ bước của cái đang được gợi ý.
...
- **Backspace trước một phần mở rộng còn lại một mình sẽ bước lên một thư mục**, như nó làm trong một ô trống; phần mở rộng đơn độc biến mất.
- **F2 trên một ô đang mở biến nó thành đổi tên ngay tại chỗ nó đang đứng**, giữ nguyên văn bản, con trỏ và vùng chọn, và **Tập trung vào thanh đường dẫn** đưa việc đổi tên ra khỏi đó theo cùng cách như vậy.
