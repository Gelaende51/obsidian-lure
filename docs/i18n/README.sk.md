<!-- Preklad README.md — stav: commit f133f41.
...
- **Spotreba** — 3. augusta – 6. septembra 2026, 22 relácií, \~13378 odpovedí: \~16,3 mil. vygenerovaných tokenov, \~62,3 mil. odoslaných, \~4245,1 mil. opätovných čítaní z vyrovnávacej pamäte (\~4323,6 mil. celkom).
...
- **Zoznam sa otvorí na položke, v ktorej stojíš**, a prechádzanie šípkami alebo ukazovateľom vyplní pole tým, na čo ukazuješ. Keď prejdeš za ktorýkoľvek koniec zoznamu, vráti sa to, čo si napísal, a keď z neho ukazovateľ odtiahneš, zvýraznenie sa vráti tam, kde si bol.
...
- **Názvy sa dopĺňajú počas písania** — kde sa názvy v priečinku zhodujú, zhoda sa objaví za kurzorom, označená; písanie ju pohlcuje písmeno po písmene, <kbd>Tab</kbd> alebo <kbd>→</kbd> ju vezme celú, <kbd>Backspace</kbd> ju vráti. Zoznam ďalej filtruje podľa toho, čo si napísal, nie podľa toho, čo bolo ponúknuté.
...
- **Napíš URL** — `https://`, `obsidian://`, alebo cestu `file://` či zakódovanú percentami — a otvorí sa, namiesto aby sa brala ako názov poznámky. Webové adresy idú na kartu vlastného Web viewer (webového prehliadača) Obsidianu, ak ho máš zapnutý.
...
Uvedené na [community.obsidian.md/plugins/lure](https://community.obsidian.md/plugins/lure), ale zatiaľ neschválené pre prehliadač v aplikácii — nainštaluj ho teda jedným z týchto spôsobov:
