...
- **Butang pensel pada folder** menukar interaksi yang sama kepada mod alih/tukar nama, dengan pemeriksaan yang sama seperti dilakukan Obsidian. Nama yang sudah digunakan berwarna merah dalam senarai, dan memilihnya membuka kedua-dua laluan bersebelahan untuk disunting, dengan tukar tempat, nama atau kedua-duanya sepilih sahaja.
