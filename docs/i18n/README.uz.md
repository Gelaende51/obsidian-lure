<!-- README.md tarjimasi — holat: commit 99fc83e.
...
- **Ombor ildizi panel ushlab turishi mumkin bo‘lgan sahifalarni ko‘rsatadi** — `:graph`, `:search` va plaginlaringiz ro‘yxatdan o‘tkazgan har qanday ko‘rinishlar. Birini tanlang yoki yozing: ikki nuqta hech bir fayl nomini boshlamaydi, shuning uchun yorliqlar manzil vazifasini ham bajaradi. Papka ichida yozilgan `:graph` o‘sha papkaning grafini ochadi. Boshlang‘ich sahifa plagini o‘rnatilgan bo‘lsa, omborning o‘z ajratgichi birinchi bosishda o‘sha sahifani ochadi, keyingisida esa fayl daraxtini yig‘adi.
