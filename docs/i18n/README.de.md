<!-- Übersetzung von README.md — Stand: Commit 99fc83e.
...
- **Die Stift-Ordner-Schaltfläche** stellt dieselben Interaktionen auf Umbenennen/Verschieben um, geprüft so, wie Obsidian selbst prüft. Ein bereits vergebener Name ist in der Liste rot, und wählst du ihn aus, öffnen sich beide Pfade nebeneinander zum Bearbeiten, mit Plätzen, Namen oder beidem tauschen nur einen Klick entfernt.
...
*Im Umbenennen-/Verschieben-Modus bietet dasselbe Dropdown anderes an: oben angeheftet der aktuelle Name der Notiz, um sie zu verschieben, ohne sie umzubenennen; Ordner, in die sie verschoben werden kann; und bereits vergebene Namen in Rot; wählst du einen aus, wird gefragt, was mit der Datei im Weg geschehen soll.*
...
- **Claude Opus 5 / 5.5** und **Claude Sonnet 5** (Anthropic, über Claude Code) — Umsetzung, Übersetzungen und Dokumentation, nach Vorgabe des Autors. Siehe [KI-Offenlegung](#ki-offenlegung).
