<!-- Oversættelse af README.md — status: commit 33b0e60.
...
- **Ophav** — en model, der skriver Obsidian-plugins, har lært det af open source-kode, dokumentation, forumsvar og fejlrapporter, som folk skrev og gav væk. Ingen af dem blev spurgt, krediteret eller betalt. Det er det største ukrediterede bidrag her, og det fortjener din støtte mere end dette plugin: skal du vælge, hvor noget skal sendes hen, så send det derhen.
