...
- **Consumo** — 3 de agosto – 6 de setembro de 2026, 22 sessões, \~13 378 respostas: \~16,3 M tokens gerados, \~62,3 M enviados, \~4245,1 M releituras em cache (\~4323,6 M no total).
