...
- **Consumo** — 3 de agosto – 17 de setembro de 2026, 23 sessões, \~14 844 respostas: \~19,2 M tokens gerados, \~85,2 M enviados, \~4800,6 M releituras em cache (\~4905,0 M no total).
