...
*Áthelyezés/átnevezés módban ugyanaz a lista mást kínál: legfelül rögzítve a jegyzet jelenlegi neve, hogy átnevezés nélkül lehessen áthelyezni; alatta a mappák, amelyekbe áthelyezhető; a már foglalt nevek pedig pirosak; egy ilyen kiválasztása megkérdezi, mit tegyen az útban lévő fájllal.*
