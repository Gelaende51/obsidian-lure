...
- **Varattu nimi kysyy sen sijaan, että se kieltäytyisi.** Siirtäminen tai uudelleennimeäminen nimelle, joka on jo olemassa, avaa valintaikkunan, jossa on kaksi muokattavaa polkua: minne tiedostosi menee, ja minne tiellä oleva tiedosto menee, punaisena niin kauan kuin se on yhä varattu. Kumpikin polku piirretään myös samalla tavalla kuin polkupalkki piirtää sellaisen, poikkeavat osat väritettyinä ja lyhennettyinä viimeisenä. Molemmilla kentillä on luettelo; toinen sisältää tavalliset ulospääsyt — vaihda paikkaa (menee tiedostosi vanhaan kansioon), vaihda nimet (pysyy paikallaan ja saa tiedostosi vanhan nimen), vaihda molemmat (saa tiedostosi vanhan polun), `-1`, `-bak` ja `-old` oman nimensä perään, sekä molempien tiedostojen alkuperäiset nimet. Ulospääsy, jonka polku on varattu, näkyy harmaana. Jonkin valitseminen vain täyttää kentän; Käytä siirtää molemmat, linkkeineen kaikkineen, ja Peruuta ei siirrä mitään. Varatun nimen valitseminen alasvetoluettelosta kysyy samaa, samoin tiedoston pudottaminen kansioon, jolla jo on kyseinen nimi.
...
- **Tarjous on aina se, minkä Sarkain kirjoittaisi.** Kohdassa, jossa nimet lakkaavat olemasta yhteneviä, kenttä tarjoaa askeleen kohti ensimmäistä niistä, ja rivi, johon Sarkain veisi, ratkaisee sen; nimen ylikirjoittaminen jättää sen päätteen paikalleen ja tarjoaa sen edessä; juuri astuttuun kansioon tarjotaan sen ensimmäistä askelta. Ennen oli tiloja, joissa mitään ei tarjottu, ja Sarkain kirjoitti silti jotain. Alasvetoluettelon alleviivaus seuraa tarjousta sen muuttuessa, ja Sarkain riviltä, jolle on siirrytty nuolilla, valitsee kyseisen rivin eikä sen vierestä.
...
- **Nimet, jotka alkavat kirjoittamallasi, näkyvät alasvetoluettelossa ensin**, merkittynä viivalla reunassa — sinisenä, missä ne jakavat enemmän kuin kirjoitit, vihreänä haarassa, johon tarjous kääntyy, missä ne eroavat — ennen nimiä, jotka vain sisältävät sen. Jokainen niistä alleviivaa askeleen, jonka <kbd>Sarkain</kbd> ottaisi kohti sitä, ei vain sitä, joka on tarjottu.
...
- **Askelpalautin ennen yksinään jäänyttä päätettä nousee tason ylöspäin**, kuten se tekee tyhjässä kentässä; yksinäinen pääte katoaa.
