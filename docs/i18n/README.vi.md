...
- **Nguồn cội** — một mô hình viết được phần mở rộng cho Obsidian đã học điều đó từ mã nguồn mở, tài liệu, câu trả lời trên diễn đàn và báo cáo lỗi mà người ta viết ra rồi cho không. Không ai trong số họ được hỏi, được ghi công hay được trả tiền. Đó là đóng góp vô danh lớn nhất ở đây, và nó xứng đáng với sự ủng hộ của bạn hơn phần mở rộng này: nếu bạn đang chọn nơi để gửi gì đó, hãy gửi tới đó.
