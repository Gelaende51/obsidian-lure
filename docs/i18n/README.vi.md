...
- **Nút bút chì trên thư mục** chuyển chính các thao tác đó sang di chuyển/đổi tên, được kiểm tra hợp lệ theo đúng cách Obsidian kiểm tra. Một tên đã được dùng sẽ hiện màu đỏ trong danh sách, và chọn nó sẽ hỏi rằng nên đổi tên thứ đang chắn đường, hay đổi chỗ, hay đổi tên cho nhau với nó.
