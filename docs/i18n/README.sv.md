<!-- Översättning av README.md — status: commit f133f41.
...
- **Förbrukning** — 3 aug – 6 sep 2026, 22 sessioner, \~13 378 svar: \~16,3 M genererade token, \~62,3 M skickade, \~4245,1 M cachade omläsningar (\~4323,6 M totalt).
