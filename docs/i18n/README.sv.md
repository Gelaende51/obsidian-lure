...
- **Namn fyller i sig själva medan du skriver** — det <kbd>Tabb</kbd> skulle skriva dyker upp efter markören, markerat — det mappens namn är överens om, eller steget mot det första av dem; när du skriver sväljs det bokstav för bokstav, <kbd>→</kbd> tar en bokstav, <kbd>Tabb</kbd> eller <kbd>End</kbd> tar det helt, <kbd>Backsteg</kbd> tar tillbaka det. Listan fortsätter att filtrera på det du skrev, inte på det som erbjöds.
