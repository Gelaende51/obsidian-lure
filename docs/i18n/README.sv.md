<!-- Översättning av README.md — status: commit 2cbb237.
...
*I flytt-/namnbytesläge ändrar samma lista vad den erbjuder: anteckningens nuvarande namn fastnålat överst för att flytta den utan att byta namn, mappar att flytta den till, och namn som redan är upptagna i rött; att välja ett frågar vad som ska göras med filen i vägen.*
