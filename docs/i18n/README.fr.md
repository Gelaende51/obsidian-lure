...
- **Consommation** — du 3 août au 19 septembre 2026, 20 sessions, \~16 460 réponses : \~19,9 M de tokens générés, \~87,0 M envoyés, \~5451,0 M de relectures mises en cache (\~5558,0 M au total).
...
- **Le bouton crayon-dossier** bascule les mêmes interactions en mode déplacer/renommer, avec les mêmes validations qu'Obsidian applique. Un nom déjà pris apparaît en rouge dans la liste, et le choisir demande s'il faut renommer ce qui fait obstacle, échanger les emplacements, ou échanger les noms avec lui.
