<!-- Překlad README.md — stav: commit 2cbb237.
...
*V režimu přesunu/přejmenování nabízí tentýž seznam něco jiného: nahoře připnutý současný název poznámky, aby ji šlo přesunout bez přejmenování; pod ním složky, kam ji přesunout; a už obsazené názvy červené; jejich výběr se zeptá, co udělat se souborem, který je v cestě.*
