...
- **Tombol pensil pada folder** mengalihkan interaksi yang sama ke mode pindah/ganti nama, diperiksa dengan cara Obsidian memeriksanya. Nama yang sudah dipakai berwarna merah di daftar, dan memilihnya membuka kedua jalur berdampingan untuk diedit, dengan pertukaran tempat, nama, atau keduanya tinggal sekali pilih.
