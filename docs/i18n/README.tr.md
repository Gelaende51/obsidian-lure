...
- **Adlar yazarken kendini tamamlar** — <kbd>Tab</kbd>'ın yazacağı şey imlecin ardında, seçili olarak belirir — klasördeki adların ortak olduğu kısım, ya da ilkine doğru olan adım; yazdıkça harf harf yutulur, <kbd>→</kbd> bir harfini alır, <kbd>Tab</kbd> veya <kbd>End</kbd> tamamını alır, <kbd>Backspace</kbd> geri çeker. Açılır liste, önerilene göre değil, yazdığınıza göre süzmeye devam eder.
