...
- **Consumo** — 3 de ago. a 17 de set. de 2026, 23 sessões, \~14.844 respostas: \~19,2 milhões de tokens gerados, \~85,2 milhões enviados, \~4.800,6 milhões de releituras em cache (\~4.905,0 milhões no total).
