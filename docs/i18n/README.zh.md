...
- **用量** — 2026 年 8 月 3–13 日，九次会话，约 4,928 次回复：生成约 720 万词元，发送约 2,370 万，缓存重读约 11.696 亿（合计约 12.005 亿）。
- **上游** — 会写 Obsidian 插件的模型，是从人们写下并无偿放出的开源代码、文档、论坛回答和缺陷报告里学会的。没有人被征询、被署名或被支付。那是这里最大的一份无名贡献，也比这个插件更值得你的支持：如果你在挑要把东西送去哪里，就送去那边。
...
- **设置：**对齐方式、分隔符预设、哪一次点击打开列表、仓库名、点文件。
