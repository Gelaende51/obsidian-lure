...
| **Azul** | Solo en modo renombrar/mover: la entrada *conservar este nombre* — un destino más que algo que existe, así que se destaca entre los nombres de archivo con los que convive |
