...
export const EN = {
	...
	// The dialog for a move or rename that lands on a taken name
	collisionTitle: "Name already taken",
	collisionBody: '"{name}" is already there.',
	collisionMoving: "Moving",
	collisionOccupant: "In the way",
	collisionRenameLabel: 'Rename "{name}" first, to:',
	collisionRenameCta: "Rename it and continue",
	collisionRenameTip: 'Renames "{name}" to the name in the field, then finishes the move.',
	collisionSwapPlaces: "Swap places",
	collisionSwapPlacesTip: '"{name}" moves to {folder} and is renamed "{moving}", and this file takes its place.',
	collisionSwapNames: "Swap names",
	collisionSwapNamesTip: '"{a}" and "{b}" trade names. Links follow each file.',
	collisionSwapNamesAcrossTip: '"{b}" stays in its folder and is renamed "{a}", and this file takes its place. Links follow each file.',
	collisionCancelTip: "Nothing is moved or renamed.",
	collisionNameTaken: '"{name}" is taken there too.',
