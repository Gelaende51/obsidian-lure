...
export const EN = {
	...
	collisionHint: "Both paths can be edited. The second field's list holds the usual ways out; picking one only fills the field.",
	...
	collisionSamePath: "Both files would land on the same path.",
	collisionPathTaken: '"{path}" is taken.',
